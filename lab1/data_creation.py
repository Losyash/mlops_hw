...
from settings import (
    DATA_URL, DATASET_PATH, DATASET_FILENAME,
    DATASET_RAW_FOLDER, DATASET_SPLITTED_FOLDER
)

warnings.filterwarnings('ignore')

if not os.path.exists(f'{DATASET_PATH}/{DATASET_FILENAME}'):
    gdown.download(
        DATA_URL,
        f'{DATASET_PATH}/{DATASET_FILENAME}',
        quiet=False,
        fuzzy=True
    )
